          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                <a class="dropdown-item" href="product-single.html">Electrónicos</a>
                <a class="dropdown-item" href="cart.html">Salud</a>
                <a class="dropdown-item" href="checkout.html">Juguetes</a>
                <a class="dropdown-item" href="checkout.html">Carnes</a>
                <a class="dropdown-item" href="checkout.html">Frutas y verduras</a>
                <a class="dropdown-item" href="checkout.html">Bebidas</a>
                <a class="dropdown-item" href="checkout.html">Limpieza y hogar</a>
                <a class="dropdown-item" href="checkout.html">Zona Escolar</a>
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('../images/bab.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">

            <h1 class="mb-0 bread">Cuidado de bebés</h1>
          </div>
        </div>
      </div>
    </div>
 ...
 <?php
     $link = new mysqli("localhost","root","","bdd");
  $consulta="SELECT * from  productos where id_subcategoria=4 and existencia>0";
   $i=1;
