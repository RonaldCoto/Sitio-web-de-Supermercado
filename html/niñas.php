...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('../images/ni.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">

            <h1 class="mb-0 bread">Juego de niñas</h1>
          </div>
        </div>
      </div>
    </div>
 ...
 <?php
     $link = new mysqli("localhost","root","","bdd");
  $consulta="SELECT * from  productos where id_subcategoria=20 and existencia>0";
   $i=1;
