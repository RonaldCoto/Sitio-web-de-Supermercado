    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="dulce.php" class="img-prod"><img class="img-fluid" src="../images/dulce.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="dulce.php">Pan Dulce</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="frances.php" class="img-prod"><img class="img-fluid" src="../images/frances.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="frances.php">Pan Frances</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="pastel.php" class="img-prod"><img class="img-fluid" src="../images/pastel.png" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="pastel.php">Pastel</a></h3>
