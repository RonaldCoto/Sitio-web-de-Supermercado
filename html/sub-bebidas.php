    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="alcohol.php" class="img-prod"><img class="img-fluid" src="../images/alcohol.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="alcohol.php">Alchool</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="bebicalientes.php" class="img-prod"><img class="img-fluid" src="../images/bebidas.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="bebicalientes.php">Bebidas Calientes </a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="carbonatadas.php" class="img-prod"><img class="img-fluid" src="../images/carbonatadas.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="carbonatadas.php">Carbonatadas</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="jugos.php" class="img-prod"><img class="img-fluid" src="../images/jugos.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="jugos.php">Jugos</a></h3>
