...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('../images/es.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">

            <h1 class="mb-0 bread">Zona Escolar</h1>
          </div>
        </div>
      </div>
    </div>
 ...
 <?php
     $link = new mysqli("localhost","root","","bdd");
  $consulta="SELECT * from  productos where id_subcategoria=30 and existencia>0";
   $i=1;
