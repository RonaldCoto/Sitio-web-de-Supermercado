    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="ambientadores.php" class="img-prod"><img class="img-fluid" src="../images/ambientador.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="ambientadores.php">Ambientadores</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="plagas.php" class="img-prod"><img class="img-fluid" src="../images/plagas.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="plagas.php">Control de Plagas</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="desinfectante.php" class="img-prod"><img class="img-fluid" src="../images/desinfectante.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="desinfectante.php">Desinfectantes</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="lavanderia.php" class="img-prod"><img class="img-fluid" src="../images/lavanderia.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="lavanderia.php">Lavandería</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="lavaplatos.php" class="img-prod"><img class="img-fluid" src="../images/lavaplatos.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="lavaplatos.php">Lavaplatos</a></h3>
