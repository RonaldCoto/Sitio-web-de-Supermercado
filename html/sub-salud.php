    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="jarabes.php" class="img-prod"><img class="img-fluid" src="../images/jarabe.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="jarabes.php">Jarabes</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="bucal.php" class="img-prod"><img class="img-fluid" src="../images/bucal.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="bucal.php">Bucal</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="corporal.php" class="img-prod"><img class="img-fluid" src="../images/shampoo.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="corporal.php">Corporal</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="desodorante.php" class="img-prod"><img class="img-fluid" src="../images/desodorante.png" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="desodorante.php">Desodorante</a></h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="pastillas.php" class="img-prod"><img class="img-fluid" src="../images/pastillas.jpg" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="pastillas.php">Pastillas</a></h3>
